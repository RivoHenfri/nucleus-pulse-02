...
//
// Nothing follows the mark. No "what do you think?", no prompt to reflect, no
// leadership line. The WhatsApp thread is where the room talks, and it will do
// that better if the app stopped talking first.
...
const GAPS = beats(1600, 2700, 2600, 2400, 2600, 3000, 2400);
